...
class BlogPage(Page):
    ...
    feed_image = models.ForeignKey('wagtailimages.Image', on_delete=models.SET_NULL, null=True,blank=True)
    private_field = models.CharField(max_length=255, default='some_default_value')
